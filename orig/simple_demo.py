...
#UseGSSAPI = "gssapi-with-mic"
#DoGSSAPIKeyExchange = "gssapi-kex"
port = 22
...
if not UseGSSAPI and not DoGSSAPIKeyExchange and not keyfile:
...
try:
    ...
    if not UseGSSAPI and not DoGSSAPIKeyExchange:
        print("in key")
        client.connect(hostname, port, username, look_for_keys=True,pkey=key)
    else:
        try:
            client.connect(
                hostname,
